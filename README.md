...
Okay, so now the owner decided to compare the databases. You've seen that the
...
After this whole mess they both agreed to use your code, but asked you to do
